...
const timeline = [
  { year: "Création", title: "Les débuts à Tours", desc: "Transports Ligneo démarre son activité de convoyage automobile, avec pour ambition la rigueur d'un grand groupe et la proximité d'une équipe locale." },
