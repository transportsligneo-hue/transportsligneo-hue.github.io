...
const Email = ({ prenom, numero, depart, arrivee, date, prestation, prix, convoyeur, clientLogoUrl, clientName }: Props) => (
  <LigneoEmailShell
    ...
    primaryCta={{ label: 'Suivre ma mission en direct', href: 'https://transportsligneo.fr/dashboard-client/missions' }}
